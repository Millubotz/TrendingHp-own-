...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()] #Channel id for auto indexing ( make sure bot is admin )
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002239809844') # support group id ( make sure bot is admin )
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/mawhVerify/10') # Tutorial video link for opening shortlink website 
