...
log_channel_id = -1002202300892  # Replace with your log channel ID
...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🍁 Update Channel 🍁', url="https://t.me/+Qa4JhgNYgMllMzdl")
                  ]]
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/moviesandwebserieshubOrzz') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
        ...
        for file in files:
            ...
            if await db.has_premium_access(message.from_user.id): 
               ...
               if not await check_verification(client, message.from_user.id) and VERIFY == True:
                   ...
                   text="<b>♨️ YOU ARE NOT VERIFIED !\nKINDLY VERIFY TO CONTINUE & YOU CAN GET UNLIMITED ACCESS FOR 4 HOURS ✅\n\n⚜️ इस BOT से MOVIE प्राप्त करने के लिए आपको VERIFY करना आवश्यक है VERIFY करने के बाद आप 4 घंटे तक UNLIMITED MOVIES प्राप्त कर सकते हो।\n\n🎯 IF YOU ARE HAVING ANY PROBLEM WITH VERIFICATION SEND SCREENSHOT SCREEN RECORDING SHOWING THE PROBLEM TO @OrzzQueryBot AND ASK FOR HELP.\n\n🔥 अगर आप VERIFY नहीं करना चाहते तो आप PREMIUM ले सकते हो, PRIMIUM लेने के बाद आप UNLIMITED MOVIES प्राप्त कर पाओगे और आपको VERIFY करने कोई जरूरत नहीं है\n\nPLAN DETAILS के लिए CLICK करें /plan</b>",
                   protect_content=False,
                   reply_markup=InlineKeyboardMarkup(btn)
                   )
