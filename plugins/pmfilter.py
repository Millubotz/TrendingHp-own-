...
async def give_filter(client, message):
    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=f"https://t.me/mawhOrzzBackUp2")]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/moviesandwebserieshubOrzz")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
       ...
       #@Deendayal_dhakad
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
            InputMediaPhoto("https://envs.sh/0GL.jpg")
        )
        await query.message.edit_text(
...
#Deendayal403
        ...
        buttons = [[           
            InlineKeyboardButton('⚜️ Movie Group ⚜️', url="https://t.me/MawhOrzzRequestGroup"),
            InlineKeyboardButton('☔ Contact ☔', url="https://t.me/OrzzSupportBot")
        ],[
            InlineKeyboardButton('🔥 Movie Update Notification 🔥', url="https://t.me/+ATen87YgHbk2MDll"),
            InlineKeyboardButton('👮 Update Channel 👮', url="https://t.me/mawhOrzzBackUp2")
        ],[
            InlineKeyboardButton('⇍ ʙᴀᴄᴋ ⇏', callback_data='start')
        ]] 
        reply_markup = InlineKeyboardMarkup(buttons)
            ...
            if not files:
                ...
                if settings["spell_check"]:
                  #  st=await message.reply_sticker(sticker="CAACAgQAAxkBAAEq2R9mipkiW9ACyj7oQXznwKTPHqNCXQACkBUAA3mRUZGx4GwLX9XCHgQ")
                    ai_sts = await message.reply_text('~𝑴𝑨𝑾𝑯 𝑶𝒓𝒛𝒛⁠• 𝑪𝒉𝒆𝒄𝒌𝒊𝒏𝒈 𝒀𝒐𝒖𝒓 𝑺𝒑𝒆𝒍𝒍𝒊𝒏𝒈...')
